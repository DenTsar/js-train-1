...
console.log("isPrimeNumber(0)", isPrimeNumber(0));
...
console.log("isPrimeNumber(53)", isPrimeNumber(53));
...
function checkDataType(value) {
  ...
  return `${value} має тип ${typeof value}`;
}
...
function getUserStatus(age) {
  ...
  if (age < 16) return "Неповнолітній";
  else if (age < 65) return "Дорослий";
